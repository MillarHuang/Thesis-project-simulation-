...
"""
sim_algorithm = function(TT,k,gamma,theta,n){
...
#simulating longitudinal data for n=10 subjects for the case of T=40, k=5
sim_data = sim_algorithm(TT=TT,k=k,gamma=gamma,theta=theta,n=n)
View(sim_data)
